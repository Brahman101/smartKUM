...
@section('css')
<link rel="stylesheet" href="{{asset('css/inovasisimprokum.css')}}">
@endsection
...
<section>
    <div class="video-container d-flex flex-column align-items-center justify-content-center">
        <div class="video-player d-flex align-items-center justify-content-center ">
            <iframe width="560" height="315" src="https://www.youtube.com/embed/fNgckjWgJ64?si=4xIMwIUbFhcql0m0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        </div>
