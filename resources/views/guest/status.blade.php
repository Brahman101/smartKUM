...
<link rel="stylesheet" href="{{asset('css/guest/status2.css')}}">
@endsection

@section('content')
<div class="outer-container d-flex justify-content-center allign-items-center">
    <div class="status-container">
        <div class="status-inner">
            ...
            <div class="row rounded p-4 login-page">
